...
4. The Triage Worker performs entity extraction, summarization, memorability scoring, and conflict detection against existing memories in the workspace; writes results back to the `WorkspaceDO` via RPC (not direct SQL).
...
| 4. Core Tools + Envelope | 3/5 | In Progress|  |
