...
- [ ] **PRE-05**: `.planning/phases/01-foundation/01-CF-CODE-ASSIST-USAGE.md` scaffolded with the 3-question checklist columns per CLAUDE.md AI Model Routing. Every v0.2 code-producing task appends a row.
