 ...
 *
 * Implementation note: this file is an intentional sibling of
 * `packages/mcp-server/src/analytics.ts` — same implementation, separate module to
 * avoid a shared package dependency between two independent Workers. Analogous to the
 * ai-helper.ts sibling pattern introduced in Plan 05-04.
 *
